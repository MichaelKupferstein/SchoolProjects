...
public class DocumentImplTest {
    ...
    void createWithNullUri(){
        ...
        String strNull = null;
        byte[] nullByte = null;
        assertThrows(IllegalArgumentException.class, () -> new DocumentImpl(this.uri,strNull, null));
    ...
    void createATXTDocumentAndUseMethods() {
        DocumentImpl test = new DocumentImpl(this.uri,"This is a test String", null);
        ...
        DocumentImpl test2 = new DocumentImpl(this.uri,"This is a test String", null);
    ...
    void equalsShouldReturnTrue() throws URISyntaxException {
        ...
        DocumentImpl temp = new DocumentImpl(uri, "test", null);
        DocumentImpl temp2 = new DocumentImpl(uri, "test", null);
    ...
    void equalsShouldReturnFalse() throws URISyntaxException {
        DocumentImpl temp = new DocumentImpl(generateRandomURI(), "test", null);
        DocumentImpl temp2 = new DocumentImpl(generateRandomURI(), "test2", null);
    ...
    void testHashCode() throws URISyntaxException {
        URI uri = generateRandomURI();
        DocumentImpl temp1 = new DocumentImpl(uri,"This is a test TXT document", null);
        DocumentImpl temp2 = new DocumentImpl(uri,"This is a test TXT document", null);
        DocumentImpl temp3 = new DocumentImpl(generateRandomURI(),"This is another test TXT document", null);
    ...
    void getWordsTest()throws Exception{
        ...
        URI uri = generateRandomURI();
        DocumentImpl temp = new DocumentImpl(uri,testInput, null);
